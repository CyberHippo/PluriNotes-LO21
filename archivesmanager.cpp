...
///Suppression d'une note via la fonction erase(). Cette fonction ne supprime pas la note, elle supprime le pointeur de note dans le tableau de pointeurElle est appelé que quand on restaure la note
